...
export const TopUsersXeroxReport = () => {
  const topUsers = getTopUsers("Xerox C7125", 3);

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Top 3 Usuarios - Xerox C7125</h2>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-green-600">{user.total.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span>Copias:</span>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {topUsers.map((user: any, index) => (
                  <tr key={index} className={`border-b hover:bg-gray-50 ${index === 0 ? 'bg-green-50' : ''}`}>
