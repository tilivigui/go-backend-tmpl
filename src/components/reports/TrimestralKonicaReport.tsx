...
import { getKonicaData } from "@/data/printerData";

export const TrimestralKonicaReport = () => {
  const data = getKonicaData();

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Reporte Trimestral - Konica C454</h2>
        <span className="text-sm text-gray-500">Marzo - Mayo 2024</span>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Usuarios Konica C454 - Período Trimestral</CardTitle>
        </CardHeader>
        <CardContent>
