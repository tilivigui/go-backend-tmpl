...
export const MensualXeroxReport = () => {
  const data = getMensualTotals("Xerox C7125");

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Reporte Mensual Totales - Xerox C7125</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {data.map((mes: any, index) => (
          <Card key={index}>
            <CardHeader>
              <CardTitle className="text-center text-green-600">{mes.mes}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="font-medium">Total:</span>
                  <span className="font-bold text-green-600">{mes.total.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span>Copias:</span>
